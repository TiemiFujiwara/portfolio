...
const butterflyLight = document.querySelector(".light-butterfly");
const butterflyDark = document.querySelector(".dark-butterfly");
...
function changeTheme() {
  ...
  if (htmlElement.classList.contains("dark")) {
    ...
    butterflyLight.classList.add("hidden");
    butterflyDark.classList.remove("hidden");
    ...
    butterflyLight.classList.remove("hidden");
    butterflyDark.classList.add("hidden");
...
const windowsList = [
  ...
  document.querySelector(".links-window"),
...
const windowsAll = document.querySelectorAll(
  ".about-window, .links-window, .portfolio-window, .contact-window",
);
...
closeButtons.forEach((button) => {
  button.addEventListener("click", (event) => {
    const windowForClosing = event.target.closest(
      ".about-window, .links-window, .portfolio-window, .contact-window",
    );
    if (windowForClosing) {
...
const barsWindow = document.querySelectorAll(
  ".about-window-bar, .links-window-bar, .portfolio-window-bar, .contact-window-bar",
);
